...
<!-- jqeury cdn -->
  ...
  <script>
    ...
    $(document).ready(function() {
      // Select the "Add Doctor" button by its ID and add a click event listener
      $('#addDoctorButton').on('click', function() {
        // Use Bootstrap's modal() method to open the modal by its ID
...
<body class="sb-nav-fixed">
                  ...
                  if ($result) {
                    while ($row = mysqli_fetch_assoc($result)) {
                      ...
                      echo '<tr>
                                            ...
                                            <a class="btn btn-secondary p-1 ml-1" href="update-doctors.php?id=' . $id . '" role="button">Update</a>
          ...
          <center>
            <div class="signup-box">
              <form onsubmit="return validateForm()" action="add-doctor.php" method="post" enctype="multipart/form-data">
                ...
                <div class="label-field">
                  <label for="option" class="label-select">Speciality: </label>
                  <select class="custom-select" name="specialist" style="width: 100%; padding:6px; border-radius:6px; outline:none;border:1px solid crimson;margin-top:3px;" required>
                ...
                <button type="submit" class="signup-btn btn-primary">Add Doctor</button>
                <br>
                <br>
              </form>
            </div>
  ...
  <div class="modal fade" id="updateDoctorModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
