...
<div id="layoutSidenav">
    ...
    <button id="printButton" class="btn btn-primary p-2 rounded-25"><i class="fas fa-print"></i> Print</button>
</div>
                    <div class="card-body">
        ...
        <tbody>
            ...
            if ($historyResult) {
                while ($historyRow = mysqli_fetch_assoc($historyResult)) {
                    ...
                    $patientName = $historyRow['patient_name'];
                    $email = $historyRow['email'];
                    $preferredDate = $historyRow['preferred_date'];
...
const tableToPrint = document.getElementById('datatablesSimple');

printButton.addEventListener('click', () => {
    printDiv(tableToPrint);
});

function printDiv(div) {
    const printContents = div.outerHTML;
