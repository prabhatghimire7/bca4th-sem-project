      ...
      <ul>
        ...
        <li>
          <div class="form-group w-25">
            <input type="text" id="searchInput" class="search form-control" placeholder="Search Doctor" style="outline: none; padding: 4px; border:1 px solid crimson;">
        ...
        <div class="modal-body my-modal-body">
          <form method="post" action="booking-page.php">
            ...
            <div class="form-group">
              ...
              <input type="date" id="date" name="date" class="my-input" min="<?php echo date('Y-m-d')?>">
            </div>
